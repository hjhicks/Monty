 ...
 *         "Monty Hall" problem. A problem that seems very simple at first yet is
...
public class Monty {
	private int doors;
	private HashMap<Integer, Boolean> dMap, badDoors;
	private int myDoor;
...
//		System.out.println("As opposed to " + (double) (1/(double) doors) *100 + "% without Switching");
//		System.out.println("");
//		System.out.println("Losing Approximately " + (double) ((losses / N) * 100) + "% of the time");
//		System.out.println("As opposed to " + (double) (100-(1/(double) doors) *100) + "% without Switching");
//		System.out.println("");
...
//		int doorNum = (int) ((Math.random() * DOORS) + 1);
	 ...
	 * @author hickshj
	 *
	 *         Creates a HashMap of False Doors for the purposes of revealing doors
	 *
